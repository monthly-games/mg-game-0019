...
**게임명 (설계)**: 길드 오브 방랑자들 (Guild of Wanderers)
**게임명 (실제)**: Gem Puzzle (보석 매치 퍼즐) ⚠️
**장르 (설계)**: 길드 협동 + 방치 RPG + 보스 레이드
**장르 (실제)**: Match-3 퍼즐 게임
**시작일**: 2025-07-01
**현재 진척도**: 8% (잘못된 게임 구현)
...
- **GDD 설계**: 길드 오브 방랑자들 (길드 협동 방치 RPG)
- **실제 코드**: Gem Puzzle (보석 매치 퍼즐)
- **상태**: 완전히 다른 게임이 구현됨
